...
func (_m *Bank) GetCertificate() *bank.Certificate {
	ret := _m.Called()

	var r0 *bank.Certificate
	if rf, ok := ret.Get(0).(func() *bank.Certificate); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*bank.Certificate)
		}
	}
...
func (_c *Bank_GetCertificate_Call) Return(_a0 *bank.Certificate) *Bank_GetCertificate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Bank_GetCertificate_Call) RunAndReturn(run func() *bank.Certificate) *Bank_GetCertificate_Call {
	_c.Call.Return(run)
	return _c
}
