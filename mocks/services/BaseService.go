...
import (
	...
	common "github.com/libercapital/pix-sdk-go/common"

	io "io"

	mock "github.com/stretchr/testify/mock"

	services "github.com/libercapital/pix-sdk-go/services"
)
...
func (_m *BaseService) CreateRequest(url string, method string, body io.Reader) (*http.Request, error) {
	...
	var r0 *http.Request
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, io.Reader) (*http.Request, error)); ok {
		return rf(url, method, body)
	}
...
func (_c *BaseService_CreateRequest_Call) RunAndReturn(run func(string, string, io.Reader) (*http.Request, error)) *BaseService_CreateRequest_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *BaseService) Execute(r *http.Request, options ...common.RequestOption) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*http.Request, ...common.RequestOption) (*http.Response, error)); ok {
		return rf(r, options...)
	}
...
func (_c *BaseService_Execute_Call) RunAndReturn(run func(*http.Request, ...common.RequestOption) (*http.Response, error)) *BaseService_Execute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *BaseService_SetAuthorizer_Call) RunAndReturn(run func(services.ServiceAuthorizer)) *BaseService_SetAuthorizer_Call {
	_c.Call.Return(run)
	return _c
}
