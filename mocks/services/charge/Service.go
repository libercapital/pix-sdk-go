...
import (
	charge "github.com/libercapital/pix-sdk-go/services/charge"
...
func (_m *Service) CreateCharge(create charge.CreateCharge) (*charge.Charge, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(charge.CreateCharge) (*charge.Charge, error)); ok {
		return rf(create)
	}
...
func (_c *Service_CreateCharge_Call) RunAndReturn(run func(charge.CreateCharge) (*charge.Charge, error)) *Service_CreateCharge_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Service) FindCharge(txId string, options ...*charge.FindChargeOption) (*charge.Charge, error) {
	...
	var r0 *charge.Charge
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ...*charge.FindChargeOption) (*charge.Charge, error)); ok {
		return rf(txId, options...)
	}
...
func (_c *Service_FindCharge_Call) RunAndReturn(run func(string, ...*charge.FindChargeOption) (*charge.Charge, error)) *Service_FindCharge_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Service) FindCharges(charges charge.ListCharges) (*charge.Charges, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(charge.ListCharges) (*charge.Charges, error)); ok {
		return rf(charges)
	}
...
func (_c *Service_FindCharges_Call) RunAndReturn(run func(charge.ListCharges) (*charge.Charges, error)) *Service_FindCharges_Call {
	_c.Call.Return(run)
	return _c
}
